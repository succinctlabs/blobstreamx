...
async fn main() {
    ...
    loop {
        ...
        if target_block - curr_head == 1 {
            ...
            blobstreamx
                .request_header_range(target_block)
                .send()
                .await
                .expect("failed to request combined skip");
        }
